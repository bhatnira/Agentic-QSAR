"""Atom-pair fingerprint representation."""

from __future__ import annotations

from typing import Any

from cta_qsar.chemistry.fingerprints import atompair_fingerprints
from cta_qsar.core.interfaces import CostEstimate
from cta_qsar.representations.base import FingerprintRepresentation


class AtomPairFingerprint(FingerprintRepresentation):
    name = "atom_pair"
    version = "1.0.0"
    ...
    def applicability(self, task_type: str, dataset_props: dict[str, Any]) -> tuple[bool, str]:
        return True, "atom-pair topological fingerprints"
    ...
    def transform(self, smiles: list[str]) -> Any:
        return atompair_fingerprints(smiles, n_bits=self.n_bits)

PLUGINS = [AtomPairFingerprint]
